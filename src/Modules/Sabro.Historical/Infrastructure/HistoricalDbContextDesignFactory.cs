...
/// registered through HistoricalModule.RegisterServices.
/// </summary>
public sealed class HistoricalDbContextDesignFactory : IDesignTimeDbContextFactory<HistoricalDbContext>
{
