...
namespace Sabro.Play.Infrastructure.Migrations
{
    ...
    [Migration("20260805165111_AddNahloDailyPuzzle")]
    partial class AddNahloDailyPuzzle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sabro.Play.Domain.MnoDailyPuzzle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("TileForm")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("tile_form");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mno_daily_puzzles");

                    b.HasIndex("GameId", "Expression")
                        .HasDatabaseName("ix_mno_daily_puzzles_game_id_expression");

                    b.HasIndex("GameId", "Date", "Difficulty")
                        .IsUnique()
                        .HasDatabaseName("ix_mno_daily_puzzles_game_id_date_difficulty");

                    b.ToTable("mno_daily_puzzles", "play");
                });

            modelBuilder.Entity("Sabro.Play.Domain.NahloDailyPuzzle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_nahlo_daily_puzzles");

                    b.HasIndex("GameId", "ChantId")
                        .HasDatabaseName("ix_nahlo_daily_puzzles_game_id_chant_id");

                    b.HasIndex("GameId", "Date")
                        .IsUnique()
                        .HasDatabaseName("ix_nahlo_daily_puzzles_game_id_date");

                    b.ToTable("nahlo_daily_puzzles", "play");
                });
