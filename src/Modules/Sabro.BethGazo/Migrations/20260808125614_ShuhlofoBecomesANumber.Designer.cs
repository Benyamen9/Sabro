...
namespace Sabro.BethGazo.Migrations
{
    ...
    [Migration("20260808125614_ShuhlofoBecomesANumber")]
    partial class ShuhlofoBecomesANumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sabro.BethGazo.Domain.BethGazoSection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("7a2c4b20-0000-4000-8000-000000000006"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Mahebrone",
                            Position = 6,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
            ...
            modelBuilder.Entity("Sabro.BethGazo.Domain.BethGazoSectionMode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            SectionId = new Guid("7a2c4b20-0000-4000-8000-000000000006"),
                            ModeId = new Guid("6f9b1a10-0000-4000-8000-000000000001")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Sabro.BethGazo.Domain.Chant", b =>
                {
                    ...
                    b.Property<int?>("ShuhlofoNumber")
                        .HasColumnType("integer")
                        .HasColumnName("shuhlofo_number");
                    ...
                    b.HasIndex("Transliteration", "SectionId", "ModeId", "ShuhlofoNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_chants_identity");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("Transliteration", "SectionId", "ModeId", "ShuhlofoNumber"), false);
