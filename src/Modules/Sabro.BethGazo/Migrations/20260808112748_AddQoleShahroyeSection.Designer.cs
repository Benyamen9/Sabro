...
namespace Sabro.BethGazo.Migrations
{
    ...
    [Migration("20260808112748_AddQoleShahroyeSection")]
    partial class AddQoleShahroyeSection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sabro.BethGazo.Domain.Chant", b =>
                {
                    ...
                    b.HasIndex("Transliteration", "SectionId", "ModeId", "Shuhlofo")
                        .IsUnique()
                        .HasDatabaseName("ix_chants_identity");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("Transliteration", "SectionId", "ModeId", "Shuhlofo"), false);
