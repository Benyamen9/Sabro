...
export type ContentArea = Schemas['ContentArea']
export type AreaAccess = Schemas['AreaAccess']
export type AreaGrantDto = Schemas['AreaGrantDto']
export type SetAreaAccessRequest = Schemas['SetAreaAccessRequest']
...
export type ModeRequest = Schemas['ModeRequest']
export type SectionRequest = Schemas['SectionRequest']
